...
import {
    ...
    SEND_PRIVATE_FAILURE,
    GET_DIALOG_REQUEST,
    GET_DIALOG_SUCCESS,
    GET_DIALOG_FAILURE,
} from '../actions/profile/messages';
import {
    GET_UNREAD_REQUEST,
    GET_UNREAD_SUCCESS,
    GET_UNREAD_FAILURE,
} from '../actions/frame/sidebar';
import {
...
} from '../actions/profile/collections';
...
import {
    ...
    EDIT_THREAD_SUCCESS,
    EDIT_THREAD_FAILURE,
} from '../actions/forum/board';
import {
    DELETE_POST_REQUEST,
    DELETE_POST_SUCCESS,
    DELETE_POST_FAILURE,
} from '../actions/forum/thread';
import {
    NEW_REGISTER_REQUEST,
    NEW_REGISTER_SUCCESS,
    NEW_REGISTER_FAILURE,
} from '../actions/passport/register';
import {
    SEND_APPEAL_REQUEST,
    SEND_APPEAL_SUCCESS,
    SEND_APPEAL_FAILURE,
} from '../actions/passport/appeal';
import {
    EDIT_PROFILE_REQUEST,
    EDIT_PROFILE_SUCCESS,
    EDIT_PROFILE_FAILURE,
} from '../actions/profile/edit';
import {
...
import {
    ...
    FORGET_AUTH_SUCCESS,
    FORGET_AUTH_FAILURE,
    FORGET_RESET_REQUEST,
    FORGET_RESET_SUCCESS,
    FORGET_RESET_FAILURE,
} from '../actions/passport/forget';
import {
    OLD_LOGIN_REQUEST,
    OLD_LOGIN_SUCCESS,
    OLD_LOGIN_FAILURE,
    OLD_REGISTER_REQUEST,
    OLD_REGISTER_SUCCESS,
    OLD_REGISTER_FAILURE,
} from '../actions/passport/old';
import {
    SEARCH_THREAD_REQUEST,
    SEARCH_THREAD_SUCCESS,
    SEARCH_THREAD_FAILURE,
} from '../actions/common/search';
...
const crossSliceReducer = (state, action) => {
    switch (action.type) {
        case 'LOGIN_SUCCESS':
            return state.set('user', fromJS(action.json.data)).set('redirectLogin', false);
