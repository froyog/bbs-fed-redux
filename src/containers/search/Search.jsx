...
class SearchWrapper extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        const {
            match: {
                params: { keyword: nextKeyword, page: nextPage },
            },
            search,
        } = nextProps;
        const {
    ...
    render() {
        ...
        return (
            <Card title={`帖子“${params.keyword}”搜索结果`} className="card-search">
                ...
                <Pager>
                    <Pager.Item disabled={params.page === 1} onClick={this.handleClickPrev}>
                        上一页
                    </Pager.Item>
                    <Pager.Item disabled={result.length < 50} onClick={this.handleClickNext}>
                        下一页
                    </Pager.Item>
                </Pager>
            </Card>
