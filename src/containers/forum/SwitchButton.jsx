...
import {
    ...
    likePost,
    lockThread,
} from '../../actions/forum/switchButton';
...
class SwitchButton extends React.Component {
    ...
    render() {
        return this.props.children(this.state.active, this.handleClickButton);
    }
}
...
const mapDispatchToProps = dispatch => ({
    ...
    onChangeCollectState: (tid, nextColloectState) =>
        dispatch(collectThread(tid, nextColloectState)),
