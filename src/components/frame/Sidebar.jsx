...
const Sidebar = ({
    ...
    return (
        <nav id="sidebar" role="navigation" style={sidebarOpenStyle}>
            {isLogin ? (
                <div className="avatar">
                    <Avatar id={selfUid} />
                    <p className="username">{selfName}</p>
                    <p className="signature">{selfSignature || '这个人很懒什么都没有留下'}</p>
                    <Button className="raised opearate logout" onClick={handleLogout}>
                        登出
                    </Button>
                </div>
            ) : (
                <div className="avatar">
                    ...
                    <p>
                        <Button href="/passport/login" className="raised opearate">
                            登录
                        </Button>
                        <Button href="/passport/register" className="raised opearate">
                            注册
                        </Button>
                    </p>
                </div>
